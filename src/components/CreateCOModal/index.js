  ...
  render() {
    ...
    return (
                                ...
                                <Modal.Content className="ranty-modal__content">
                                        ...
                                        this.state.payPeriod && (
                                            <div className="row row--align-center pay-period">
                                                <div className="form-field">
                                                    ...
                                                    <Input className="form-field__input" placeholder="5-ое число" />
                                    ...
                                    }
                                    {
                                        this.state.notificationPeriod && (
                                            <div className="row row--align-center notification-period peny">
                                                <div className="form-field">
                                                    <p className="form-field__label">Срок уведомления для перезаключения договора</p>
                                                    <Input style={{ marginRight: 30 }} className="form-field__input" placeholder="1" />
                                                    <p className="form-field__label">дней</p>
                                                </div>
                                            </div>
                                        )
                                    }
                                    ...
                                    {
                                        this.state.rentHolidays && this.state.index && (
                                    ...
                                    <div className="row row--align-center save-shablon">
                                        <Checkbox
                                            className="ranty-modal__content__checkbox"
                                            label="Сохранить шаблон КП"
                                            checked={this.state.saveShablon}
                                            onClick={(e, {checked}) => this.handleClick('saveShablon', checked)}
                                        />
                                        <Input className="form-field__input" placeholder="Название шаблона" />
                                    </div>
                                </Modal.Content>
                                <Divider className="divider" />
                            </React.Fragment>
        ...
        <Modal.Actions className="ranty-modal__actions">
            ...
            <button className="ranty-modal__actions__button ranty-modal__actions__button--gray" onClick={e => this.setState({ preview: !preview })}>
                { preview ? 'Вернуться' : 'Посмотреть КП' }
            </button>
        </Modal.Actions>
    </Modal>
    )
